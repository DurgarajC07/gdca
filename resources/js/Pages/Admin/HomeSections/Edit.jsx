...
export default function HomeSectionEdit({ section }) {
    ...
    return (
        <AdminLayout>
            <Head title={`Edit ${section.name} Section`} />
            ...
            <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Edit Home Section</h1>
                        <p className="text-gray-600">Modify your homepage section</p>
                    </div>
                </div>
