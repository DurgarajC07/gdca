...
export default function MenuItemsEdit({ menuItem, pages, menuItems }) {
    const { data, setData, put, processing, errors } = useForm({
        title: menuItem.title || "",
        type: menuItem.type || "page",
        page_id: menuItem.page_id?.toString() || "",
        url: menuItem.url || "",
    ...
    // Filter out current item and its children from parent options
    const availableParentItems = menuItems.filter(item => 
        item.id !== menuItem.id && item.parent_id !== menuItem.id
    );
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Modify menu item settings and position
                        </p>
                    </div>
                </div>
