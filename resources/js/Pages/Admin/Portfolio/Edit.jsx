...
export default function PortfolioEdit({ portfolioItem }) {
    const { data, setData, put, processing, errors } = useForm({
        title: portfolioItem.title || '',
        description: portfolioItem.description || '',
        detailed_description: portfolioItem.detailed_description || '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.portfolio.update', portfolioItem.id));
    };
    ...
    return (
        <AdminLayout>
            <Head title={`Edit ${portfolioItem.title}`} />
            ...
            <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600">{portfolioItem.title}</p>
                    </div>
                </div>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    ...
                                    >
                                        ...
                                        {processing ? 'Updating...' : 'Update Portfolio Item'}
                                    </Button>
                                </CardContent>
                            </Card>
                        </div>
